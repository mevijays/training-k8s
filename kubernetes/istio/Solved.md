...
1- all virtual services from oscorp-prod ns should be able to bind to the gateway. only virtual services with hostname oscorp.example.com from namespace oscorp-dev should be able to bind to the gateway
...
Exam Question 10 (https://istio.io/latest/docs/reference/config/networking/virtual-service/)
...
Exam Question11 (https://istio.io/latest/docs/reference/config/networking/virtual-service/)
...
spec:
  ...
  - route:
    ...
    retries:
      ...
      perTryTimeout: 1s
```
Exam question 12 (https://istio.io/latest/docs/reference/config/networking/destination-rule/)
...
Exam question 13  (https://istio.io/latest/docs/reference/config/security/peer_authentication/)
...
Exam question 14 (https://istio.io/latest/docs/reference/config/security/authorization-policy/)
...
Exam question15 (https://istio.io/latest/docs/reference/config/security/authorization-policy/)
...
EXAM Question16  (https://istio.io/latest/docs/reference/config/networking/sidecar/)
